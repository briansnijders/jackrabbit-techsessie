...
public class CatalogBootstrapper {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			// Create a node under which the cars are stored. This is a direct
			// child
			// of the root node. The root node has absolute path "/", the cars
			// node
			// has relative path "cars", thus the absolute path of the cars node
			// will be
			// "/cars"
			...
			// Ask JackRabbit to save the session, thus committing and
			// persisting changes
			session.save();
